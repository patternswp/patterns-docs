 ...
 * Slug: patterns-docs/header-absolute
 * Categories: header
...
?>
<!-- wp:group {"className":"patterns-docs-header at-pos at-z-idx","style":{"spacing":{"blockGap":"0px"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group patterns-docs-header at-pos at-z-idx">
